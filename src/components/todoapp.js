    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex-row">
                ...
                <button
                    className = 'mx-auto p-1 mb-2 mt-8 text-green-600 text-4xl text-bold rounded-md hover:bg-green-400 hover:text-white cursor-pointer bg-gray-100 bg-opacity-0 flex-shrink-0'
                    onClick = {clear}>
                    Clear
                </button>
            </div>
